...
class _PrivacyPageState extends State<PrivacyPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      showGeneralDialog(
        context: context,
        barrierDismissible: false, //设置false 点击空白不关闭弹窗
        barrierLabel: '',
  ...
  Widget build(BuildContext context) {
    return Container(
      color: Colors.blue,
      //child:GestureDetector(onTap: () => print("点击了"))
    );
  }
}